...
const SingnInPage = async () => {
  ...
  return (
    <div className="w-1/2 mx-auto my-10 px-4 flex flex-col">
      ...
      {Object.values(providerMap).map((provider) => (
        <form
          ...
          <button className="cursor-pointer h-10 px-6 py-1 font-medium border border-zinc-600 flex items-center gap-2 rounded hover:bg-slate-50">
